  ...
  return (
    ...
    >
      <div className="max-w-[1240px] w-full h-screen mx-auto p-2 pb-[10] flex flex-col justify-center items-center">
        <div className="">
          {BriefIntro.map((Value, index) => (
            <React.Fragment key={index}>
              <div
                className="relative bg-gray-300 shadow-lg shadow-gray-800 rounded-[160px] mx-auto w-[20rem] h-[20rem] md:mt-9 mt-0 overflow-hidden "
              >
                <Image
                  src="/assets/Alkis.png"
                  fill
                  className="absolute object-fill hover:scale-105 ease-in duration-300"
                />
              </div>
